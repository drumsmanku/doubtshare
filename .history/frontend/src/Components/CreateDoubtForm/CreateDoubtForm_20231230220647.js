              ...
              <h2>Create doubt </h2>
                ...
                <div style={{display:'flex', width:'100%', marginBottom:'2rem', alignItems:'center'}}>
                  ...
                  <select className={styles.subjectType} name='subjecttype' value={doubt.subjecttype} onChange={handleChange}>
                    ...
                    <option value="11th">English</option>
                    <option value="12th">Hindi</option>
                    <option value="10th">Maths</option>
                    <option value="11th">Science</option>
                    <option value="11th">Social Science</option>
                    <option value="12th">Physics</option>
                    <option value="10th">Chemistry</option>
                    <option value="10th">Biology</option>
                  </select>
                </div>
