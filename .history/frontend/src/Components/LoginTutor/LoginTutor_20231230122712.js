...
function LoginTutor() {
  ...
  const login = (event) => {
    ...
    axios.post('http://localhost:4000/login/tutor', user)
      .then(res => {
      ...
      <div className={styles.mainBody}>
        <form className={styles.form}>
          ...
          <div className={styles.inputContainer}>
            <h1 className={styles.signInText}>Sign In for Tutors </h1>
          ...
          <div style={{width:'100%', display:'flex', alignItems:'center', paddingLeft:'2rem'}}>
             ...
             <u style={{ cursor:'pointer', marginLeft:'0.5rem'}} onClick={()=>{navigate('/login/student')}}>click here</u> 
          </div>
        ...
        <button className={styles.notLoggedInButton}  onClick={()=>{navigate('/register/tutor')}}>Create your DoubtShare account</button>
      </div>
